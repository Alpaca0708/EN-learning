  ...
  return (
    <Layout>
      <div className='flex flex-col p-4 bg-white w-full items-center'>
        ...
        {/* video Player */}
        <main className='border-[#d5bdaf] border-2 p-3 rounded-md flex flex-col items-center w-full md:w-1/2'>
        ...
        <div className='w-full md:w-1/2 bg-[#d4a373] p-2 rounded-md text-white '>
          {/* subtitleText */}
          ...
          <div className='w-full flex justify-around border-b-2 border-[#edede9] font-bold'>
            <button className=''
